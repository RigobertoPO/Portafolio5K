      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="Usuarios/validarUsuario.php" method="post">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <input type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" value="Enviar">  
            
          </div>

        </form>
        <div class="text-center text-lg-start mt-4 pt-2">
            <p class="small fw-bold mt-2 pt-1 mb-0">¿No tienes una cuenta? <a href="usuarios/registrarusuario.php"
